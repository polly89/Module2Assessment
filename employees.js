...
const empTwo = (empOne)=> {
    return{...empOne, 'name':'Nick', 'shifts':['weekday mornings', ' weekday afternoons']}
}

console.log(empTwo(empOne))
...
//CODE HERE
let testMan = new Manager ('Winston', ['mornings', 'afternoons'], ['Cece', ' Schmidt']);
